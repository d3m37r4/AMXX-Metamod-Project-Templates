...
function(set_output_binary_name)
    ...
    if (UNIX AND NOT APPLE)
        set_target_properties(${CMAKE_PROJECT_NAME} PROPERTIES SUFFIX "_mm_i386.so")
    elseif(APPLE)
        set_target_properties(${CMAKE_PROJECT_NAME} PROPERTIES SUFFIX "_mm.dylib")
    elseif(WIN32)
        set_target_properties(${CMAKE_PROJECT_NAME} PROPERTIES SUFFIX "_mm.dll")
    endif()
endfunction()
