...
/// <summary>
/// </summary>
constexpr auto AMXX_MODULE_NAME = "$pluginname$";
/// <summary>
/// </summary>
constexpr auto AMXX_MODULE_VERSION = "$pluginversion$";
/// <summary>
/// </summary>
constexpr auto AMXX_MODULE_AUTHOR = "$pluginauthor$";
/// <summary>
/// </summary>
constexpr auto AMXX_MODULE_LOG_TAG = "$pluginlogtag$";
/// <summary>
/// </summary>
constexpr auto AMXX_MODULE_URL = "$pluginurl$";
/// <summary>
/// </summary>
...
/// <summary>
/// </summary>
constexpr auto AMXX_MODULE_LIBRARY = "$pluginlibrary$";

/// <summary>
/// </summary>
constexpr auto AMXX_MODULE_LIB_CLASS = "$pluginlibclass$";
