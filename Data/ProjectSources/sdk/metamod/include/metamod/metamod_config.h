 ...
 * -------------------------------------------------------------------------------------------
 */
constexpr auto META_PLUGIN_NAME = "$pluginname$";
constexpr auto META_PLUGIN_VERSION = "$pluginversion$";
constexpr auto META_PLUGIN_AUTHOR = "$pluginauthor$";
constexpr auto META_PLUGIN_LOG_TAG = "$pluginlogtag$";
constexpr auto META_PLUGIN_URL = "$pluginurl$";
constexpr auto META_PLUGIN_LOADABLE = $pluginloadable$;
constexpr auto META_PLUGIN_UNLOADABLE = $pluginunloadable$;
